...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<h2>Create new</h2><input id="firstName" placeholder="First Name"> <input id="lastName" placeholder="Last Name"> <input id="phone" placeholder="Phone number"> <input id="email" placeholder="Email Address"><div class="form-controls"><button type="button" id="saveContact">Save</button> <a id="clearCreateForm" href="#">Clear</a></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav><ul class="pagination"></ul></nav>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<p>First name: <input class="contact-firstName" value="'+
((__t=( firstName ))==null?'':_.escape(__t))+
'"></p><p>Last name: <input class="contact-lastName" value="'+
((__t=( lastName ))==null?'':_.escape(__t))+
'"></p><p>Phone: <input class="contact-phone" value="'+
((__t=( phone ))==null?'':_.escape(__t))+
'"></p><p>Email: <input class="contact-email" value="'+
((__t=( email ))==null?'':_.escape(__t))+
'"></p><button class="contact-save">Save</button> <button class="contact-cancel">Cancel</button>';
}
return __p;
};
